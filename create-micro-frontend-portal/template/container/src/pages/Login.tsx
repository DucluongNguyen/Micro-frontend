import { Alert, Button, Card, Flex, Form, Input, Typography, theme as antdTheme } from 'antd';
...
export default function Login() {
  ...
  // Hardcoded '#f0f2f5' would stay light-gray behind a dark Card once dark
  // mode is on (this page renders before login, outside AppLayout, so it
  // doesn't inherit any background from there) - `colorBgLayout` is the
  // same page-background token Layout itself uses, so it tracks the
  // current algorithm instead of a fixed color.
