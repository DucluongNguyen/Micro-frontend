...
/**
 * Same contract shape as Dashboard, exposed from ../setting/src/App.tsx.
 */
declare module 'Setting/App' {
  export interface RemoteAppProps {
    theme?: import('antd').ThemeConfig;
  }
...
/**
 * Same contract shape as Dashboard, exposed from ../info/src/App.tsx.
 */
declare module 'Info/App' {
  export interface RemoteAppProps {
    theme?: import('antd').ThemeConfig;
  }
...
declare module 'Setting/navigation' {
  export interface RemoteNavItem {
    path: string;
    label: string;
    icon?: string;
...
declare module 'Info/navigation' {
  export interface RemoteNavItem {
    path: string;
    label: string;
    icon?: string;
